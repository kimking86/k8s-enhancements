...
Please note that the kube-proxy working group now has working implementation for
most of the below goals, with CI, conformance testing, and fine grained sig-network tests
passing for the most critical use cases, including both linux and windows.
